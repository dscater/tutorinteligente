            ...
            <div class="menu">
                ...
                >
                    <Link :href="route('progresos.index')" class="menu-link">
                        ...
                        <div class="menu-text">Progreso y Seguimiento</div>
                    </Link>
                </div>
                <div
                    v-if="
                ...
                >
                    <Link :href="route('puntuacions.index')" class="menu-link">
                        ...
                        <div class="menu-text">Puntuaciones</div>
                    </Link>
                </div>
                <div
                    v-if="
                ...
                <div
                    ...
                    class="menu-item"
                    :class="[
                        route_current == 'concepto_estudiantes.index'
                            ? 'active'
                            : 'none',
                    ]"
                >
                    <Link
                        :href="route('concepto_estudiantes.index')"
                        class="menu-link"
                    >
                        <div class="menu-icon">
                            <i class="fa fa-list"></i>
                        </div>
                        <div class="menu-text">Conceptos</div>
                    </Link>
                </div>
                <div
                    v-if="
                ...
                <div
                    ...
                    class="menu-item"
                    :class="[
                        route_current == 'cuestionarios.index'
                            ? 'active'
                            : 'none',
                    ]"
                >
                ...
                <div
                    v-if="
                        user_logeado.permisos == '*' ||
                        user_logeado.permisos.includes('conceptos.index')
                    "
                    class="menu-item"
                    :class="[
                        route_current == 'conceptos.index' ? 'active' : 'none',
                    ]"
                >
                    <Link :href="route('conceptos.index')" class="menu-link">
                        <div class="menu-icon">
                ...
                >
                    <Link :href="route('estudiantes.index')" class="menu-link">
                        ...
                        <div class="menu-text">Estudiantes</div>
                    </Link>
                </div>
                <div
                    v-if="
                        user_logeado.permisos == '*' ||
                        user_logeado.permisos.includes('tipo_patologias.index')
                    "
                    class="menu-item"
                    :class="[
                        route_current == 'tipo_patologias.index'
                            ? 'active'
                            : 'none',
                    ]"
                >
                    <Link
                        :href="route('tipo_patologias.index')"
                        class="menu-link"
                    >
                        <div class="menu-icon">
                            <i class="fa fa-list"></i>
                ...
                >
                    ...
                    >
                        ...
                        <div class="menu-text">Lista de Estudiantes</div>
                    </Link>
                </div>
                <div
                    v-if="
                ...
                >
                    ...
                    >
                        ...
                        <div class="menu-text">
                            Puntuación, Progresos y Seguimiento
                        </div>
                    </Link>
                </div>
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div class="menu-text">Puntuación y Progresos</div>
                    </Link>
                </div>
                <div
                    v-if="
